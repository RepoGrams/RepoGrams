<div class="col-md-12 center-block">
	<script type="text/javascript" src="js/jquery.overscroll.min.js"></script>
		<div class="custom" style="width:400; boder-style:solid; display:inline-block;">
			...
			<li class="customBlock" id="1" style="background-color:rgb(260,0,66); width:110px; height:20px;" data-html="true" 
			...
			data-placement="right" rel="tooltip"></li>
			<li class="customBlock" id="1" style="background-color:rgb(98,226,0); width:290px; height:20px;" data-html="true" 
			data-original-title="Ok, you got the concept. The first rendering is fixed by us. The next one can be parametrized."
			data-placement="right" rel="tooltip"></li>
			...
			data-placement="right" rel="tooltip"></li>
			<li class="customBlock" id="1" style="background-color:rgb(0,128,255); width:90px; height:20px;" data-html="true" 

<div class="col-md-12 center-block">
	<script type="text/javascript" src="js/jquery.overscroll.min.js"></script>
		<div class="custom" style="width:400; boder-style:solid; display:inline-block;">
			...
			<li class="customBlock" id="1" style="background-color:rgb(51,251,0); width:400px; height:16px;" data-html="true" 
			...
			<li class="customBlock" id="1" style="background-color:rgb(255,0,0); width:250px; height:16px;" data-html="true" 
			data-original-title="Thats the way you do it. Each block in your chromogram represents one commit of your repository."
			data-placement="right" rel="tooltip"></li>
			<li class="customBlock" id="1" style="background-color:rgb(255,137,0); width:150px; height:16px;" data-html="true" 
			data-original-title="Ok, you got the concept. The first rendering is fixed by us. The next one can be parametrized."
			data-placement="right" rel="tooltip"></li>
			<li class="customBlock" id="1" style="background-color:rgb(0,255,218); width:400px; height:16px;" data-html="true" 

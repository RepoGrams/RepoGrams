...
RUN if [ -f /var/www/html/repoprepopulatelist.json ]; then sed -i -e '/@@@PREPARE_LIST@@@/{r /var/www/html/repoprepopulatelist.json' -e 'd}' /var/www/html/js/controllers.js; fi
